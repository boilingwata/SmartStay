    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="btn-outline flex items-center gap-2" onClick={() => toast.success('Đã gửi lại thông báo cho cư dân!')}><Send size={18} /> Gửi lại thông báo</button>
        ...
        <div className="lg:col-span-4 space-y-8">
           ...
           <div className="card-container p-8 space-y-8 sticky top-6 shadow-2xl shadow-primary/5 transition-all hover:shadow-primary/10">
              ...
              <div className="space-y-3">
                 <button className="btn-primary w-full py-4 flex items-center justify-center gap-2 text-md shadow-lg shadow-primary/20">
