-- Unsplash hotlinks often return 401 in browsers; replace with fixed Picsum /id/* building-style photos.
...
WHERE ri.url ILIKE '%images.unsplash.com%'
   OR ri.url ILIKE '%unsplash.com%';
